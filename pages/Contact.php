...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="vi">
    <head>
        ...
        <link href="../1234/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
        ...
        <script src="../1234/js/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../1234/js/1234.js" type="text/javascript"></script>
		<script src="../1235/js/1235.js" type="text/javascript"></script>
		<script src="../1248/js/jquery.js"></script>
        <script src="../1248/js/amination.js"></script>
		<script src="../1267/js/modul-0-splash.js" ></script>
		<script src="../1267/js/bootstrap.min.js"></script>
